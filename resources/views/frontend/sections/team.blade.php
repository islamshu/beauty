                    ...
                    <div class="carousel-inner">
                            ...
                            <div class="item-inner">
                                <div class="expertBox">
                                    <div class="expertImage">
                                        <img class="lazyestload" data-src="{{asset('front/img/home/team-1.jpg')}}" src="{{asset('front/img/home/team-1.jpg')}}" alt="Image expert">
                        ...
                        <div class="carousel-item">
                            <div class="item-inner">
                                <div class="expertBox">
                                    <div class="expertImage">
                                        <img class="lazyestload" data-src="{{asset('front/img/home/team-2.jpg')}}" src="{{asset('front/img/home/team-2.jpg')}}" alt="Image expert">
                                        <div class="expertMask">
                                            <div class="socialArea">
                                                <ul class="list-inline">
                                                    <li><a href="javascript:void(0)"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                        ...
                        <div class="carousel-item">
                            <div class="item-inner">
                                <div class="expertBox">
                                    <div class="expertImage">
                                        <img class="lazyestload" data-src="{{asset('front/img/home/team-3.jpg')}}" src="{{asset('front/img/home/team-3.jpg')}}" alt="Image expert">
                                        <div class="expertMask">
                                            <div class="socialArea">
                                                <ul class="list-inline">
                                                    <li><a href="javascript:void(0)"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                        ...
                        <div class="carousel-item">
                            <div class="item-inner">
                                <div class="expertBox">
                                    <div class="expertImage">
                                        <img class="lazyestload" data-src="{{asset('front/img/home/team-4.jpg')}}" src="{{asset('front/img/home/team-4.jpg')}}" alt="Image expert">
                                        <div class="expertMask">
                                            <div class="socialArea">
                                                <ul class="list-inline">
                                                    <li><a href="javascript:void(0)"><i class="fa fa-facebook" aria-hidden="true"></i></a>
