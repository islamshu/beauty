                                    ...
                                    <form class="form form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="row mt-1">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="label-control">{{ __('البريد الإلكتروني') }}</label>
                                                        <div class="form-control-static">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{ number_format($order->package->price, 2) }} {{ __('شيكل') }}</td>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                @if($order->latitude && $order->longitude)
                                                    <div id="order-map" style="height: 200px; border: 1px solid #ddd;"></div>
                                                @else
                                                    <div class="alert alert-warning">{{ __('لا يوجد إحداثيات للعنوان') }}</div>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
