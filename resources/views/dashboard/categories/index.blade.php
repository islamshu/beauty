                ...
                <section>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button class="btn btn-primary mb-3" data-toggle="modal" data-target="#categoryModal">إضافة
                                فئة</button>
                                        ...
                                        <tr id="category-{{ $category->id }}">
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-warning edit-category"
                                                    data-id="{{ $category->id }}"
                                                    data-name="{{ $category->name }}">تعديل</button>
                                                    @if(isAdmin())
            ...
            $('#category-form').submit(function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (id) {
                            $('#category-' + id).find('td:nth-child(2)').text(response.category
                                .name);
